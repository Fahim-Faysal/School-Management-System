...
namespace SchoolManagementSystem
{
    public partial class IndividualDetails : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\faysa\Desktop\SchoolManagementSystem\SchoolManagementSystem\school.mdf;Integrated Security=True;User Instance=True");
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select name,mother,gender,cast,mobile,email,dob,standard,medium,privious_school,year,address from student where std_id=" + Convert.ToInt32(textBox1.Text) + " ;";      
